        ...
        <div>
            {
                ...
                <div>
                    ...
                    <form className='App' onSubmit={(event) => handleSearch(event)}>
                        <input type='text' placeholder='enter firstName or lastName' onChange={(event) => setSearch(event.target.value)} value={search}/>
                    </form>
                    <br></br>
                    {
                        users.length?
                        ...
                        :
                        <h3 className='App'>Sorry, No user Found..!</h3>
                    }
