...
import { Back, Tokens } from '@src/assets/img';
          ...
          <div className="card">
            <div className="send-header">
              ...
              >
                ...
                <p className="text-white-75 text-base">{`${homeState.activeAccount.name} / ${settingsState.networks.activeNet.symbol}`}</p>
              </div>
              <div className="mt-5 p-6 bg-primary rounded-md">
                <div className="flex flex-col">
                  ...
                  <div className="relative bottom-2 text-black text-lg justify-start font-bold">
                    {`${homeState.activeAccount.balance.bal} ${settingsState.networks.activeNet.symbol}`}
                  </div>
