...
import { EditContactProps } from '@src/interfaces-and-types/contacts';
...
const EditCreatedContact: FC<EditContactProps> = ({ details, showPopups }) => {
                ...
                <div className="flex flex-col space-y-1 px-5">
                  ...
                  <div className="bg-transparent border dark:border-white-10 border-black-10 rounded-md h-12 w-full space-y-2">
                    <input
                      ...
                      placeholder={`Example (${details.username})`}
                      type="text"
                      value={username}
...
export default EditCreatedContact;
